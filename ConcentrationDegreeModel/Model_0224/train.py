DATA_FILE = 'ConcentrationDegreeModel\Model_0224\\training_data\\data'
NCLASSES  = 4
MODEL = 'ConcentrationDegreeModel\Model_0224\\models\\model_pose.hdf5'
################################################################################
#
#                                LOADING DATA
#
...
def loadData(classnumber):
    '''
        This function loads the training data for a class. 这个函数为一个类加载训练数据。
        ...
        =======
         ...
         classnumber : int
              The number that represents the class.代表类的数字。
...
################################################################################
#
#               SPLITTING DATA INTO TRAIN AND TEST SETS   将数据分成训练集和测试集
#
################################################################################
